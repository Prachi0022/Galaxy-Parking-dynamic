...
/* ================================
    Read More Toggle for Service Boxes
    ================================ */
function initReadMore() {
    document.querySelectorAll('.service-box-items').forEach(card => {
        const text = card.querySelector('.service-box-text');
        ...
        const checkOverflow = () => {
            // Reset styles temporarily to measure full height
        ...
        // Run check after page load and images are loaded
...
window.addEventListener("load", () => {
  ScrollTrigger.refresh();
    ...
    // 991px এবং নিচে - শুধু পিন বন্ধ, অন্য GSAP animations চালু থাকবে
    "(max-width: 1199px)": function () {
        // শুধুমাত্র project-panel এর pinning বন্ধ করা হবে, সব GSAP animation কাজ করবে
